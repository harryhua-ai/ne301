...
#if !defined(UX_HOST_STANDALONE) && !defined(UX_HOST_CLASS_NETWORK_NO_NX)
#include "nx_api.h"
...
#if defined(UX_HOST_CLASS_NETWORK_NO_NX)
    VOID            (*ux_host_class_cdc_ecm_activate_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm, UCHAR *mac);
    VOID            (*ux_host_class_cdc_ecm_deactivate_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm);
    VOID            (*ux_host_class_cdc_ecm_link_up_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm);
    VOID            (*ux_host_class_cdc_ecm_link_down_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm);
    VOID            (*ux_host_class_cdc_ecm_receive_callback)(struct UX_HOST_CLASS_CDC_ECM_STRUCT *cdc_ecm, NX_PACKET *packet);
#else
