...
#if defined(HW_CRYPTO_DPA_AES)
  ctx->ctx_save_cr = ((SAES_TypeDef *)(ctx->hcryp_ccm.Instance))->CR;
#else
  ctx->ctx_save_cr = ((CRYP_TypeDef *)(ctx->hcryp_ccm.Instance))->CR;
#endif
                          ...
                          size_t add_len)
{
  ...
  if (add_len > 0)
  {
    ...
    #if defined(HW_CRYPTO_DPA_AES)
      ((SAES_TypeDef *)(ctx->hcryp_ccm.Instance))->CR = ctx->ctx_save_cr;
    #else
      ((CRYP_TypeDef *)(ctx->hcryp_ccm.Instance))->CR = ctx->ctx_save_cr;
    #endif
