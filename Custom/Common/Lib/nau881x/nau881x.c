...
{
    nau881x->_register[NAU881X_REG_SILICON_REV] = nau881x->read_reg(NAU881X_I2C_ADDRESS,NAU881X_REG_SILICON_REV);
...
nau881x_status_t NAU881x_Register_Write(NAU881x_t* nau881x, uint8_t register_addr, uint16_t value)
{
    nau881x->write_reg(NAU881X_I2C_ADDRESS, register_addr, value);
