...
#define NORMAL_SUSPENDED                 0x00000002U
...
HAL_StatusTypeDef HAL_CRYP_Suspend(CRYP_HandleTypeDef *hcryp)
{
  ...
  else if ( __HAL_CRYP_GET_IT_SOURCE(hcryp, CRYP_IT_CCFIE) || __HAL_CRYP_GET_IT_SOURCE(hcryp, CRYP_IT_RWEIE) || __HAL_CRYP_GET_IT_SOURCE(hcryp, CRYP_IT_KEIE) )
  {
    ...
    __HAL_CRYP_DISABLE(hcryp);
    hcryp->State = HAL_CRYP_STATE_SUSPENDED;
    hcryp->SuspendedProcessing = NORMAL_SUSPENDED;
  }
  ...
  if (HAL_CRYP_GetState(hcryp) == HAL_CRYP_STATE_READY)
  {
    ...
    printf("Processing was already over or was about to end. No suspension done\r\n");
    return HAL_ERROR;
  }
  else
  {
...
HAL_StatusTypeDef HAL_CRYP_Resume(CRYP_HandleTypeDef *hcryp)
{
  ...
  else
  {
    ...
    else if (hcryp->SuspendedProcessing == IT_SUSPENDED)
    {
    ...
    //        (READ_BIT(hcryp->CR_saved, SAES_CR_MODE) == CRYP_OPERATINGMODE_ENCRYPT)))
    //   {
    //     if (HAL_CRYP_Encrypt(hcryp, hcryp->pCrypInBuffPtr_saved,
    //                             hcryp->Size_saved, hcryp->pCrypOutBuffPtr_saved, 500) != HAL_OK)
    //     {
    //       return HAL_ERROR;
    //     }
    //   }
    //   else
    //   {
    //     if (HAL_CRYP_Decrypt(hcryp, hcryp->pCrypInBuffPtr_saved,
    //                             hcryp->Size_saved, hcryp->pCrypOutBuffPtr_saved, 500) != HAL_OK)
    //     {
    //       return HAL_ERROR;
    //     }
