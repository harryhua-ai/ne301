...
#elif defined(CMSIS_OS_H) || defined(CMSIS_OS_H_)
#define             _ux_utility_interrupt_disable()             osKernelLock()
#else
...
#elif defined(CMSIS_OS_H) || defined(CMSIS_OS_H_)
#define             _ux_utility_interrupt_restore(flags)         osKernelRestoreLock(flags)
#else
...
#elif defined(CMSIS_OS_H) || defined(CMSIS_OS_H_)
#define             _ux_utility_time_get()                      osKernelGetTickCount()
#else
