...
#define PAHO_MQTT_SUB_ERROR_MAX_TIMES           (3)       // Define maximum consecutive failure times for MQTT subscription topic, disconnect after exceeding
#define PAHO_MQTT_PUB_ERROR_MAX_TIMES           (3)       // Define maximum consecutive failure times for MQTT publish topic, disconnect after exceeding
