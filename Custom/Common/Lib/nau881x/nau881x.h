...
typedef int (*NAU881x_Write_Func)(uint16_t DevAddr, uint8_t Reg, uint16_t value);
typedef uint16_t (*NAU881x_Read_Func)(uint16_t DevAddr, uint8_t Reg);
...
{
    NAU881x_Write_Func write_reg;
    NAU881x_Read_Func  read_reg;
