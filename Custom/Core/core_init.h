...
/* ==================== Version Information ==================== */
/* Import from centralized version header (auto-generated by build system) */
#include "version.h"

#define CORE_SYSTEM_VERSION_MAJOR   FW_VERSION_MAJOR
#define CORE_SYSTEM_VERSION_MINOR   FW_VERSION_MINOR
#define CORE_SYSTEM_VERSION_PATCH   FW_VERSION_PATCH
#define CORE_SYSTEM_VERSION_BUILD   FW_VERSION_BUILD
#define CORE_SYSTEM_VERSION_STRING  FW_VERSION_STRING
#define CORE_SYSTEM_VERSION_U32     FW_VERSION_U32
